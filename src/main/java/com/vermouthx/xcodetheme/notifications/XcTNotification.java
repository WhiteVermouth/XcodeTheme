...
public class XcTNotification {
    ...
    @Language("HTML")
    private static final String WHATS_NEW = "<ul>" + "<li>🐛 Fixed background color mismatches in Settings dialog, tool window headers, and around tree-row icons across all theme variants</li>" + "<li>🎨 Unified Editor and Tree backgrounds in Light theme variants to render with a white content surface</li>" + "</ul>";
