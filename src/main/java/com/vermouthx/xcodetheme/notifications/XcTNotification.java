...
public class XcTNotification {
    ...
    private static final String RELEASE_NOTE =
            "<p>🎉 <strong>Welcome to Xcode Theme v" + XcTManager.currentVersion() + "!</strong> Here's what's new:</p>" +
            WHATS_NEW +
            "<p>If you enjoy Xcode Theme, click <strong>☕ Donate</strong> below to support development. Your support is appreciated!</p>" +
            "<p><em>Enjoy the latest improvements!</em> ⌘</p>";

    @Language("HTML")
    private static final String WELCOME_MESSAGE =
            "<p>🎉 <strong>Welcome!</strong> Xcode Theme is now installed and ready to use.</p>" +
            "<ul>" +
            "<li>Go to <strong>Settings → Appearance & Behavior → Appearance</strong></li>" +
    ...
    public static void notifyReleaseNote(@Nullable Project project) {
        Notification notification = getNotificationGroup().createNotification(
                "🎨 Xcode Theme v" + XcTManager.currentVersion() + " - Release Notes",
                RELEASE_NOTE,
    ...
    public static void notifyWelcome(@Nullable Project project) {
        Notification notification = getNotificationGroup().createNotification(
                "🎨 Xcode Theme Successfully Installed",
                WELCOME_MESSAGE,
                NotificationType.INFORMATION
        );
        addNotificationActions(notification);
